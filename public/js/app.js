var saleMe =  angular.module('saleMe', ["ngRoute"]).config([ '$routeProvider', '$locationProvider','$httpProvider',
	function($routeProvider, $locationProvider) {
        ...
        when('/post', { controller: 'UsersCtrl', templateUrl: 'views/blog-item.html' }).
...
var urlPosts = 'http://localhost:8099/api/posts/' ;
var urlUsers = 'http://localhost:8099/api/users/' ;
